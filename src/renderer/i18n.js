...
(function () {
  const translations = {
    de: {
      ...
      crop: "Zuschneiden",
      quality: "Qualität",
      quality_title: "Qualität & Codec",
      quality_codec: "Codec",
      quality_level: "Qualität",
      quality_smaller: "Kleinere Datei",
      quality_better: "Beste Qualität",
      ratio_free: "Frei",
    ...
    en: {
      ...
      crop: "Crop",
      quality: "Quality",
      quality_title: "Quality & Codec",
      quality_codec: "Codec",
      quality_level: "Quality",
      quality_smaller: "Smaller file",
      quality_better: "Best quality",
      ratio_free: "Free",
      ratio_original: "Original",
      apply: "Apply",
      reset: "Back",
